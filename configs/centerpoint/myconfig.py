# please directly checkout lines from last
import itertools
import logging
import numpy as np
from tools.visualize import createRotation
...
# test configs
intrinsic = 'data/sjtuRoad/data_2020_07_31_10_46_48/calib.yaml'
depthPath = 'data/sjtuRoad/data_2020_07_31_10_46_48/depth/'

voxel_generator = dict(
    range=[-100, -11, -18, -3, 60, 7.0],
...
phi = 70.96
theta = 158.00095273884 - 90
rho = 160

rotMat = np.linalg.inv(createRotation([rho, phi, theta]))
